...
public class addTeamController {
    ...
    public void confirmAction() {
        ...
        if (improperInputData.stream().anyMatch(x -> !x)){
            ...
            if(textField11.getText().length() > 3){
                ...
                TugOfWarTeam team = new TugOfWarTeam(textField11.getText(), player1, player2,player3,player4,player5);
                try{
                    addToFile(team);
                }
                catch(IOException e){
    ...
    public void addToFile(TugOfWarTeam team) throws IOException {
