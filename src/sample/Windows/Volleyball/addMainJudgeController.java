...
public class addMainJudgeController {
    ...
    public void addJudge(MainJudge mainJudge) throws IOException{
        ...
        try {
            ObjectInputStream input = new ObjectInputStream(new FileInputStream("VolleyballMainJudges.ser"));
            try {
        ...
        ObjectOutputStream output = new ObjectOutputStream(new FileOutputStream("VolleyballMainJudges.ser"));
